  ...
  <div class="album">
    ...
    <div class="album-content">
      ...
      <div class="sticker-grid" id="stickerGrid">
        ...
        <div class="sticker locked sticker-wide" id="sticker-shirt" style="--tilt:0.5deg">
          <span class="sticker-notch"></span>
          <span class="sticker-tape"></span>
          <span class="label">Shirt No.</span>
          <span class="sticker-value big" id="clueShirt">—</span>
      ...
      <div class="modal-overlay hidden" id="statsModal">
        <div class="modal">
          ...
          <p class="stats-note">Your stats are counted when you guess today's player. Guessing players in the archive is not counted in your streak, but the players you guess still show up in your album.</p>
      ...
      <footer class="site-footer">
        ...
        <p class="footer-contact"><a href="mailto:hello@iconed.wtf">hello@iconed.wtf</a> · <a href="/">Back to ICONED</a></p>
      </footer>
    </div>
  </div>
